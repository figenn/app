...
export const registerSchema = z.object({
  first_name: z.string({ required_error: t('errors.firstNameRequired') })
    .min(1, t('errors.firstNameRequired'))
    .max(32, t('errors.firstNameMaxLength')),
  
  last_name: z.string({ required_error: t('errors.lastNameRequired') })
    .min(1, t('errors.lastNameRequired'))
    .max(32, t('errors.lastNameMaxLength')),

  email: z.string({ required_error: t('errors.emailRequired') })
    .min(1, t('errors.emailRequired'))
    .email(t('errors.emailValid'))
    .regex(emailValidation, t('errors.emailNoPlus')),

    country: z.string({ required_error: t('errors.countryRequired') })
    .min(1, t('errors.countryRequired'))
    .max(32, t('errors.countryMaxLength')),

  password: z.string({ required_error: t('errors.passwordRequired') })
  ...
  passwordConfirm: z.string({ required_error: t('errors.confirmPasswordRequired') })
